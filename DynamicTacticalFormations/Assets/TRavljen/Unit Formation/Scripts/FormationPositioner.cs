...
namespace TRavljen.UnitFormation
{
    ...
    public class FormationPositioner
    {
        ...
        public static List<Vector3> GetAlignedPositions(
            ...
            float targetAngle)
        {
            //Get positions from a specified type of formation
            ...
            //Pivot to the target position (mouse position)
            var pivot = targetPosition;

            //Facing angle of the formation taken from direction
        ...
        //More maths that I have no idea what its purpose is
        ...
        private static Vector3 RotatePointAroundPivot(Vector3 point, Vector3 pivot, Vector3 angles)
        {
            ...
            //Debug.Log("Euler(angles): " + Quaternion.Euler(angles));
            //Debug.Log("(point - pivot) : " + (point - pivot));
            //Debug.Log("pivot : " + pivot);
            //Debug.Log("Result : " + Quaternion.Euler(angles) * (point - pivot) + pivot);
